          ...
          <Card>
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <p className="text-gray-400 text-sm mt-1">
                {filter ? 'Aucun devis avec ce statut' : 'Créez votre premier devis'}
              </p>
            </div>
          </Card>
        ) : (
              ...
              {quotes.map((q) => (
                ...
                >
                  ...
                  <span className="col-span-3 text-sm text-gray-700">
                    {q.clientId?.name || '—'}
                    {q.clientId?.company && <span className="block text-xs text-gray-400">{q.clientId.company}</span>}
                  </span>
                  ...
                  <span className="col-span-2 text-sm font-semibold text-gray-900 text-right">{fmt(q.total)}</span>
